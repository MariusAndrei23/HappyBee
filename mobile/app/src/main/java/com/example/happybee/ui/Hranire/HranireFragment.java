...
public class HranireFragment extends Fragment {
    private HranireViewModel hranireViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        hranireViewModel =
                new ViewModelProvider(this).get(HranireViewModel.class);
        View root = inflater.inflate(R.layout.fragment_hranire, container, false);
        final TextView textView = root.findViewById(R.id.text_hranire);
        hranireViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
